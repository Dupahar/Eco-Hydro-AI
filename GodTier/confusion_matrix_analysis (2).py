...
class ConfusionMatrixAnalyzer:
    ...
    def create_comprehensive_report(self, y_true, y_pred, depth_true, depth_pred, village_name):
        ...
        print("\n3. Creating binary confusion matrix...")
        fig3 = self.plot_binary_confusion_matrix(
        ...
        print("\n4. Generating classification metrics...")
        ...
        fig4 = self.create_summary_figure(y_true, y_pred, depth_true, depth_pred, village_name)
        fig4.savefig(
...
def main():
    ...
    print("\nGenerated files:")
    print("  📊 confusion_matrix_*.png - Multi-class confusion matrices")
    print("  📊 confusion_matrix_normalized_*.png - Normalized by recall")
    print("  📊 confusion_matrix_binary_*.png - Binary classification")
